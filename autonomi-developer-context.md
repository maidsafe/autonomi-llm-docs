...
# Autonomi Developer Context

## What This Document Is

You are an AI assistant helping a developer understand the Autonomi Network. This document provides foundational knowledge about how the network works - its primitives, architectural patterns, and core concepts. Use this to help developers explore what's possible and understand how Autonomi's capabilities might apply to their use cases.

For implementation details beyond this document, refer to the Source URLs at the end.
